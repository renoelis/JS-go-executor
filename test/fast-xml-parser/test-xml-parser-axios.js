/**
 * 测试 fast-xml-parser 模块的各种功能（使用 axios）
...
console.log('🚀 开始测试 fast-xml-parser 功能（使用 axios）...\n');
...
async function testXMLValidator() {
  ...
  const xmlData = response.data;  // axios 自动处理为字符串
...
async function testParsingWithAttributes() {
  ...
  const response = await axios.get(`${BASE_URL}xml-attributes`);
  const xmlData = response.data;
...
async function testCDATA() {
  ...
  const response = await axios.get(`${BASE_URL}xml-cdata`);
  const xmlData = response.data;
...
async function testArrays() {
  ...
  const response = await axios.get(`${BASE_URL}xml-array`);
  const xmlData = response.data;
...
async function testNestedStructure() {
  ...
  const response = await axios.get(`${BASE_URL}xml-nested`);
  const xmlData = response.data;
...
async function testNumbersAndBooleans() {
  ...
  const response = await axios.get(`${BASE_URL}xml-types`);
  const xmlData = response.data;
...
async function testPreserveOrder() {
  ...
  const response = await axios.get(`${BASE_URL}xml-mixed`);
  const xmlData = response.data;
...
async function testNamespaces() {
  ...
  const response = await axios.get(`${BASE_URL}xml-namespace`);
  const xmlData = response.data;
...
async function testCommentsAndPI() {
  ...
  const response = await axios.get(`${BASE_URL}xml-comments`);
  const xmlData = response.data;
...
// 测试 13: axios 配置选项测试
// ============================================
async function testAxiosOptions() {
  console.log('📋 测试 13: axios 配置选项测试');
  console.log('─'.repeat(50));
  ...
  const xmlData = response.data;
  console.log('响应类型:', typeof xmlData);
  console.log('是否为字符串:', typeof xmlData === 'string');
...
async function runAllTests() {
  ...
  try {
    ...
    await testAxiosOptions();
    results.tests.push({ name: 'AxiosOptions', status: 'passed' });
    results.passed++;
