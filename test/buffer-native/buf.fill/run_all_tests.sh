...
TEST_DIR="$BASE_DIR/test/buffer-native/buf.fill"
...
tests=(
  ...
  "part6_missing_tests.js"
  "part7_gap_filling.js"
  "part8_official_doc_cases.js"
  "part9_additional_coverage.js"
  "part10_gap_analysis.js"
  "part11_final_coverage.js"
  "part12_missing_scenarios.js"
  "part13_final_supplement.js"
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.fill API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
