...
tests=(
  ...
  "part9_advanced_coverage.js"
  "part10_deep_edge_cases.js"
  "part11_final_coverage.js"
  "part12_missing_coverage.js"
  "part13_final_edge_cases.js"
  "part14_additional_coverage.js"
  "part15_final_missing_tests.js"
  "part16_critical_missing_tests.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.includes API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
