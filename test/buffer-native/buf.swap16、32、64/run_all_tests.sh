...
# buf.swap16/swap32/swap64 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.swap16、32、64"
...
echo "=========================================="
echo "buf.swap16/swap32/swap64 API 完整测试"
echo "=========================================="
echo ""
...
tests=(
  "part1_swap_basic.js"
  "part2_swap_types.js"
  "part3_swap_errors.js"
  "part4_swap_safety.js"
  "part5_swap_edge_cases.js"
  "part6_documentation_compliance.js"
  "part7_real_behavior_edges.js"
  "part8_final_coverage.js"
  "part9_deep_memory_scenarios.js"
  "part10_deep_error_boundaries.js"
  "part11_performance_stress.js"
  "part12_extreme_boundaries.js"
  "part13_byte_patterns_integrity.js"
  "part14_cross_method_interactions.js"
  "part15_typedarray_methods.js"
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.swap16/swap32/swap64 API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
