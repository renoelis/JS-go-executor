...
TEST_DIR="$BASE_DIR/test/buffer-native/buf.index"
...
tests=(
  "part1_basic.js"
  "part2_edge_cases.js"
  "part3_advanced_types.js"
  "part4_uint8array_compatibility.js"
  "part5_special_scenarios.js"
  "part6_missing_coverage.js"
  "part7_buffer_views.js"
  "part8_symbol_and_special_keys.js"
  "part9_strict_mode_and_frozen.js"
  "part10_iterators_and_array_methods.js"
  "part11_typed_array_interactions.js"
  "part12_performance_and_edge_cases.js"
  "part13_bigint_and_additional_coverage.js"
  "part14_final_missing_tests.js"
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf[index] API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
