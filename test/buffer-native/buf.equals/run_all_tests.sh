...
TEST_DIR="$BASE_DIR/test/buffer-native/buf.equals"
...
tests=(
  "part1_basic.js"
  "part2_typed_arrays.js"
  "part3_encodings.js"
  "part4_edge_cases.js"
  "part5_special_cases.js"
  "part6_advanced_cases.js"
  "part7_type_validation.js"
  "part8_additional_cases.js"
  "part9_extreme_cases.js"
  "part10_missing_scenarios.js"
  "part11_buffer_from_cases.js"
  "part12_prototype_chain_cases.js"
  "part13_final_edge_cases.js"
  "part14_comprehensive_supplement.js"
  "test.js"
)
...
if [ $total_failed -eq 0 ]; then
  echo "🎉 所有测试全部通过！buf.equals API 已完整对齐 Node.js v25.0.0"
  exit 0
else
