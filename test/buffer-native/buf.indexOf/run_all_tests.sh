...
tests=(
  ...
  "part2_encoding.js"
  "part3_byteoffset.js"
  "part4_value_types.js"
  "part5_edge_cases.js"
  "part6_error_handling.js"
  "part7_compatibility.js"
  "part8_advanced_coverage.js"
  "part9_missing_coverage.js"
  "part10_final_edge_cases.js"
  "part11_comprehensive_supplement.js"
  "part12_final_missing_tests.js"
  "part13_additional_edge_cases.js"
  "part14_missing_typedarray_tests.js"
  "part15_encoding_variants.js"
  "part16_memory_safety_tests.js"
  "part17_performance_edge_cases.js"
  "part18_critical_missing_tests.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.indexOf API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
