...
echo "=========================================="
echo "Buffer.alloc API 完整测试"
echo "=========================================="
echo ""

# 测试文件列表
tests=(
  "test_valueOf_objects.js"
  "part1_basic.js"
  ...
  "part12_ultimate_deep_dive.js"
  "part13_deep_gap_analysis.js"
  "deep_coverage_analysis.js"
  "final_gap_analysis.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！Buffer.alloc API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
