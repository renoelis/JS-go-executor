...
# buf.writeBigUInt64BE/LE 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.writeBigUInt64"
...
echo "=========================================="
echo "buf.writeBigUInt64BE/LE API 完整测试"
echo "=========================================="
echo ""

# 测试文件列表
tests=(
  "part1_basic_be_le.js"
  "part2_offset.js"
  "part3_errors.js"
  "part4_edge_cases.js"
  "part5_type_checks.js"
  "part6_extreme_edge_cases.js"
  "part7_combinations.js"
  "part8_extreme_pickiness.js"
  "part9_deep_supplement1.js"
  "part10_deep_supplement2.js"
  "part11_deep_supplement3.js"
  "part12_ultra_deep1.js"
  "part13_ultra_deep2.js"
  "part14_ultra_deep3.js"
  "part15_fourth_deep1.js"
  "part16_fourth_deep2.js"
  "part17_fourth_deep3.js"
  "part18_alias_tests.js"
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.writeBigUInt64BE/LE API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
