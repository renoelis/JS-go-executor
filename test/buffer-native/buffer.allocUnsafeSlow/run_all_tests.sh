...
# Buffer.allocUnsafeSlow 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buffer.allocUnsafeSlow"
...
echo "=========================================="
echo "Buffer.allocUnsafeSlow API 完整测试"
echo "=========================================="
echo ""
...
tests=(
  ...
  "part3_errors.js"
  "part4_security.js"
  "part5_performance.js"
  "part6_compatibility.js"
  "part7_edge_cases.js"
  "part8_memory_behavior.js"
  "part9_extreme_cases.js"
  "part10_final_coverage.js"
  "part11_gap_filling_tests.js"
  "part12_advanced_edge_cases.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！Buffer.allocUnsafeSlow API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
