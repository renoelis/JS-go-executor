...
TEST_DIR="$BASE_DIR/test/buffer-native/buf.length"
...
tests=(
  ...
  "part8_performance.js"
  "part9_advanced_scenarios.js"
  "part10_spec_compliance.js"
  "part11_additional_coverage.js"
  "part12_missing_coverage.js"
  "part13_final_coverage.js"
  "part14_extreme_edge_cases.js"
  "part15_additional_scenarios.js"
  "part16_property_descriptor.js"
  "part17_missing_edge_cases.js"
  "part18_property_attributes.js"
  "part19_unicode_and_special.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.length API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
