...
TEST_DIR="$BASE_DIR/test/buffer-native/buf.keys"
...
tests=(
  "part1_basic.js"
  "part2_edge_cases.js"
  "part3_iterator_protocol.js"
  "part4_compatibility.js"
  "part5_performance_and_memory.js"
  "part6_error_handling.js"
  "part7_typed_array_interop.js"
  "part8_return_value_spec.js"
  "part9_additional_coverage.js"
  "part10_missing_scenarios.js"
  "part11_deep_boundary_tests.js"
  "part12_final_coverage.js"
  "part13_spec_compliance.js"
  "part14_additional_scenarios.js"
  "part15_final_missing_tests.js"
  "part16_spec_alignment.js"
  "part17_edge_cases_final.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.keys() API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
