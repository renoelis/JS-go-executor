...
# buf.lastIndexOf 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.lastIndexOf"
...
tests=(
  ...
  "part7_additional_edge_cases.js"
  "part8_official_examples.js"
  "part9_empty_value_behavior.js"
  "part10_advanced_type_coercion.js"
  "part11_final_missing_tests.js"
  "part12_error_handling.js"
  "part13_special_cases.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.lastIndexOf API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
