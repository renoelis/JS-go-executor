// buf.writeInt32LE() - 第3轮补充：对照 Node 实际行为
...
test('实际行为：数组不能作为 this', () => {
  try {
    Buffer.prototype.writeInt32LE.call([0, 0, 0, 0], 123, 0);
    return true;
  } catch (e) {
    return false;
  }
