...
tests=(
  "test.js"
  "test_part1_basic.js"
  "test_part2_ranges.js"
  "test_part3_errors.js"
  "test_part4_static.js"
  "test_part5_supplementary.js"
  "test_part6_missing_scenarios.js"
  "test_part7_advanced.js"
  "test_part8_edge_cases.js"
  "test_part9_additional_coverage.js"
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.compare API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
