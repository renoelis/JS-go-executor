...
# buf.readFloatLE 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.read*/buf.readFloatLE"
...
tests=(
  ...
  "part3_comprehensive_coverage.js"
  "part4_typedarray_interop.js"
  "part5_precision.js"
  "part6_ieee754.js"
  "part7_error_handling.js"
  "part8_endianness.js"
  "part9_method_integrity.js"
  "part10_advanced_edge_cases.js"
  "part11_memory_safety.js"
  "part12_symbol_toprimitive.js"
  "part13_frozen_sealed_buffer.js"
  "part14_real_world_scenarios.js"
  "part15_error_codes.js"
  "part16_cross_method_consistency.js"
  "part17_additional_edge_cases.js"
  "part18_final_missing_cases.js"
  "part19_extreme_edge_cases.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.readFloatLE API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
