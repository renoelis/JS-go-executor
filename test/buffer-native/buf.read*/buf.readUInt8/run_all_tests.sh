...
# buf.readUInt8 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.read*/buf.readUInt8"
...
tests=(
  "test.js"
  "part2_edge_cases.js"
  "part3_parameter_types.js"
  "part4_value_range.js"
  "part5_buffer_sources.js"
  "part6_error_validation.js"
  "part7_method_integrity.js"
  "part8_deep_edge_cases.js"
  "part9_missing_coverage.js"
  "part10_advanced_scenarios.js"
  "part11_extreme_edge_cases.js"
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.readUInt8 API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
