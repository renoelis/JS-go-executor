// buf.readBigInt64LE() - 非 Buffer 对象调用测试
...
test('在 ArrayBuffer 上调用可能失败', () => {
  try {
    ...
    Buffer.prototype.readBigInt64LE.call(ab, 0);
    return false;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
...
test('在 DataView 上调用可能工作', () => {
  try {
    ...
    const result = Buffer.prototype.readBigInt64LE.call(dv, 0);
    return result === 0n;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
...
test('在普通对象上调用可能工作（如有索引属性）', () => {
  try {
    ...
    const result = Buffer.prototype.readBigInt64LE.call(obj, 0);
    return result === 0n;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
...
test('在类数组对象上调用可能工作', () => {
  try {
    ...
    const result = Buffer.prototype.readBigInt64LE.call(arrayLike, 0);
    return result === 0n;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
...
test('在字符串上调用可能工作（字符转为 charCode）', () => {
  try {
    const str = '00000000';
    const result = Buffer.prototype.readBigInt64LE.call(str, 0);
...
test('在数字上调用可能失败', () => {
  try {
    Buffer.prototype.readBigInt64LE.call(12345, 0);
    return false;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
...
test('在布尔值上调用可能失败', () => {
  try {
    Buffer.prototype.readBigInt64LE.call(true, 0);
    return false;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
...
test('在 Symbol 上调用可能失败', () => {
  try {
    Buffer.prototype.readBigInt64LE.call(Symbol('test'), 0);
    return false;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
...
test('在 BigInt 上调用可能失败', () => {
  try {
    Buffer.prototype.readBigInt64LE.call(100n, 0);
    return false;
  } catch (e) {
    return e.name === 'TypeError' || e.name === 'RangeError';
  }
