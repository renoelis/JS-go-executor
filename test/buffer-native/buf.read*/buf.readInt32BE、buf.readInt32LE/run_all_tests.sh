...
# buf.readInt32BE、buf.readInt32LE 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.read*/buf.readInt32BE、buf.readInt32LE"
...
echo "=========================================="
echo "buf.readInt32BE、buf.readInt32LE API 完整测试"
echo "=========================================="
echo ""
...
tests=(
  ...
  "part2_edge_cases.js"
  "part3_buffer_sources.js"
  "part4_offset_coercion.js"
  "part5_method_integrity.js"
  "part6_sequential_reads.js"
  "part7_error_messages.js"
  "part8_gap_filling.js"
  "part9_deep_edge_cases.js"
  "part10_extreme_boundaries.js"
  "part11_final_gaps.js"
  "part12_buffer_states.js"
  "part13_strict_validation.js"
  "part14_comprehensive_matrix.js"
  "part15_missing_scenarios.js"
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.readInt32BE、buf.readInt32LE API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
