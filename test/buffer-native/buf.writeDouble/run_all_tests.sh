...
# buf.writeDouble 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.writeDouble"
...
tests=(
  ...
  "part3_offset_boundaries.js"
  "part4_errors.js"
  "part5_typed_arrays.js"
  "part6_precision_and_rounding.js"
  "part7_round2_documentation.js"
  "part8_round3_edge_cases.js"
  "part9_round4_coverage.js"
  "part10_round5_extreme.js"
  "part11_deep1_params.js"
  "part12_deep2_bytes.js"
  "part13_deep3_exceptions.js"
  "part14_deep4_stress.js"
  "part15_round7_value_conversion.js"
  "part16_round7_offset_endian.js"
  "part17_deep_gap_filling.js"
  "part18_special_strings_and_edge.js"
  "part19_final_completeness.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.writeDouble API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
