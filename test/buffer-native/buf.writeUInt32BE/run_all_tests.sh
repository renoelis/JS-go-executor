...
# buf.writeUInt32BE 完整测试运行脚本
# 用于验证所有测试文件在 Go + goja 服务中的表现

set -e

BASE_DIR="/Users/Code/Go-product/Flow-codeblock_goja"
TEST_DIR="$BASE_DIR/test/buffer-native/buf.writeUInt32BE"
...
echo "=========================================="
echo "buf.writeUInt32BE API 完整测试"
echo "=========================================="
echo ""
...
tests=(
  ...
  "part2_types.js"
  "part3_errors.js"
  "part4_combinations.js"
  "part5_edge_cases.js"
  "part6_special_cases.js"
  "part7_performance.js"
  "part8_compatibility.js"
  "part9_deep_edge_cases.js"
  "part10_missing_coverage.js"
  "part11_buffer_interactions.js"
  "part12_ultra_deep_edge_cases.js"
  "part13_extreme_boundary_tests.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.writeUInt32BE API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
