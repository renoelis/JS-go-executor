...
TEST_DIR="$BASE_DIR/test/buffer-native/buf.copy"
...
tests=(
  ...
  "part4_error_handling.js"
  "part5_comprehensive_supplement.js"
  "part6_advanced_edge_cases.js"
  "part7_complete_coverage.js"
  "part8_final_supplement.js"
)
...
if [ $total_failed -eq 0 ]; then
  echo "🎉 所有测试全部通过！buf.copy API 已完整对齐 Node.js v25.0.0"
  exit 0
else
