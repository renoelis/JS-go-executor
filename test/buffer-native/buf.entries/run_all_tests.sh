...
tests=(
  "test_advanced.js"
  "test_analysis_and_supplement.js"
  "test_all.js"
  "test_complete_coverage.js"
  "test_comprehensive.js"
  "test_edge_cases.js"
  "test_final_complete.js"
  "test_final_coverage.js"
  "test_missing_coverage.js"
  "test_missing_edge_cases.js"
  "test_missing_scenarios.js"
  "test_supplement_complete.js"
...
if [ $total_failed -eq 0 ]; then
  echo "🎉 所有测试全部通过！buf.entries API 已完整对齐 Node.js v25.0.0"
  exit 0
else
