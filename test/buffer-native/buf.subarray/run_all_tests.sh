...
echo "=========================================="
echo "buf.subarray API 完整测试"
echo "=========================================="
echo ""

# 测试文件列表
tests=(
  "part1_subarray_basic.js"
  "part2_subarray_boundaries.js"
  "part3_subarray_types.js"
  "part4_subarray_errors.js"
  "part5_subarray_safety.js"
  "part6_subarray_comparison.js"
  "part7_subarray_edge_behaviors.js"
  "part8_subarray_combinations.js"
  "part9_subarray_extreme.js"
  "part10_subarray_deep_supplement.js"
  "part11_subarray_advanced_edge.js"
  "part12_subarray_ultra_deep.js"
  "part13_subarray_final_exhaustive.js"
  "part14_subarray_absolute_final.js"
  "part15_subarray_operators_and_descriptors.js"
)
...
if [ "$total_tests" -gt 0 ]; then
  ...
  if [ "$total_failed" -eq 0 ]; then
    echo ""
    echo "🎉 所有测试通过！buf.subarray API 与 Node.js v25.0.0 完全兼容！"
    exit 0
  else
    echo ""
